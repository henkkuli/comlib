...
implementors["comlib_common"] = [{"text":"impl&lt;K, V&gt; Default for MiniMap&lt;K, V&gt; <span class=\"where fmt-newline\">where<br>&nbsp;&nbsp;&nbsp;&nbsp;K: Ord,&nbsp;</span>","synthetic":false,"types":[]}];
implementors["comlib_math"] = [{"text":"impl&lt;M:&nbsp;Modulus&gt; Default for ModInt&lt;M&gt; <span class=\"where fmt-newline\">where<br>&nbsp;&nbsp;&nbsp;&nbsp;M: Default,&nbsp;</span>","synthetic":false,"types":[]},{"text":"impl Default for Mod1e9p7","synthetic":false,"types":[]}];
